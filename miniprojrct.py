...
while True:
    ...
    if re.search('news', res):
        ...
        print(t2s(f"I have found {len(news_res)} news. You can read it."))
        print(t2s(news_res[0]))
        print(t2s(news_res[1]))
    ...
    if re.search('your name|who are you', res):
        ...
        print(t2s("My name is Jarvis, I am your personal assistant"))
